...
export default function GrupoAsociativo({
    ...
    const asignarGrupo = async () => {
        try {
            if (persona.rol !== "no asignado") {
                ...
                axios.post(`${import.meta.env.VITE_REACT_APP_BACKEND_URL}/grupos/nuevo`, nuevoIntegrante);
    ...
    const getGrupos = async () => {
        try {
            let resultado = await axios.get(`${import.meta.env.VITE_REACT_APP_BACKEND_URL}/grupos/`);
